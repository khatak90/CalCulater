...
async function AskQuestion() {
    await inquirer
        ...
        else if (answers.operator == "Subract") {
            console.log(chalk.green(`${answers.num1} - ${answers.num2} = ${answers.num1 - answers.num2}`));
        }
        else if (answers.operator == "Multiply") {
            console.log(chalk.bgBlueBright(`${answers.num1} x ${answers.num2} = ${answers.num1 * answers.num2}`));
        }
        else if (answers.operator == "Divide") {
            console.log(chalk.bgGray(`${answers.num1} / ${answers.num2} = ${answers.num1 / answers.num2}`));
        }
        else {
            console.log("Error");
        }
